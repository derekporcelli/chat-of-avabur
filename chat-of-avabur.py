...
async def list_command(interaction: discord.Interaction, channel: str = default_channel):
    await interaction.response.defer()
...
async def last_messages(interaction: discord.Interaction, channel: str = default_channel):
    await interaction.response.defer()
...
async def join_channel(interaction: discord.Interaction, channel: str = default_channel):
    await interaction.response.defer()
...
async def leave_channel(interaction: discord.Interaction, channel: str = default_channel):
    await interaction.response.defer()
...
def process_message(dict_data):
    global id_to_chan, chan_to_id
...
async def main():
    ...
    websocket_server = await websockets.serve(socket_server, "localhost", 5000)
